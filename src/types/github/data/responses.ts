import { GithubResult } from '../index';

export const getExampleGithubResult: GithubResult = {
  total_count: 3809876,
  ...
  items: [
    {
      ...
      created_at: new Date('2013-05-24T16:15:54Z'),
      updated_at: new Date('2023-03-17T01:06:24Z'),
      pushed_at: new Date('2023-03-16T19:53:01Z'),
      ...
      size: 293225,
      stargazers_count: 203944,
      watchers_count: 203944,
      language: 'JavaScript',
      has_issues: true,
      has_projects: true,
      has_downloads: true,
